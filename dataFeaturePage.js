...
export default [
...

    {
        ...
        as a JaxCard holder. We never delete transaction history so you can have
    ...
    },
    {
        ...
        text: `Seamlessley connect your JaxCard with your apple 
        watch for payments and transfers. You never have to carry your card 
        with you if you don't want to. Enjoy the freedom of banking with JaxCard.`,
        img: appleWatch
    },
    {
        id: 4,
        ...
        a member of JaxCard. Forget about the swiping from the 60's and get modern by 
    ...
    },
    {
        ...
        JaxCard member. Investing for your future has never been easier.`,
        img: bitcoin
    },
