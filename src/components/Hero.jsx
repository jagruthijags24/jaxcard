    ...
    return (
        <div className="heroSection">
            <div className="heroLeft">
                <h1>The revolutionary <span className="emphasis">Jax</span>Card is finally here.</h1>
                <p className="heroText">Apply now and become one of the very few to witness 
                    the power of <span className="emphasis">Jax</span>. <span className="heroTextEmphasis">*while supplies last*</span>
                </p>
